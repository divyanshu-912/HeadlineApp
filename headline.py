...
# Load datasets
train_path = r'f:\Python Project\Headline app\data\LABELLED_TRAIN.csv'                                  
dev_path = r'f:\Python Project\Headline app\data\LABELLED_DEV.csv'
test_path =r'f:\Python Project\Headline app\data\UNLABELLED_TEST.csv'
